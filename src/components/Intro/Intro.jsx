      ...
      <div className="Intro" id="intro">
        <div className="i-left">
          <div className="i-name ">
            ...
            <span className="animate-charcte name anim">Shubham Khangar</span>
          ...
          <button
            onClick={() =>
              window.open(
                "https://drive.google.com/file/d/1aWZCCccrRm3iMQ_DvZCeKSPmzY_TaS_x/view?usp=sharing"
              )
            }
            ...
            <a
              href={Resume}
              download={"shubham_resume"} //"shubham_resume"
              rel="noreferrer"
